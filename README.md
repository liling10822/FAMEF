...
Test SOMEF_Extension installation
...
### Configure
Before running SOMEF_Extension, you must configure it appropriately. Run
...
- A GitHub authentication token [**optional, leave blank if not used**], which SOMEF_Extension uses to retrieve metadata from GitHub. If you don't include an authentication token, you can still use SOMEF_Extension. However, you may be limited to a series of requests per hour. For more information, see [https://help.github.com/en/github/authenticating-to-github/creating-a-personal-access-token-for-the-command-line](https://help.github.com/en/github/authenticating-to-github/creating-a-personal-access-token-for-the-command-line) 
