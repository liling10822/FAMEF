# FAMEF classifier
[![DOI](https://zenodo.org/badge/305866370.svg)](https://zenodo.org/badge/latestdoi/305866370)
...
- A GitHub authentication token [**optional, leave blank if not used**], which FAMEF uses to retrieve metadata from GitHub. If you don't include an authentication token, you can still use FAMEF. However, you may be limited to a series of requests per hour. For more information, see [https://help.github.com/en/github/authenticating-to-github/creating-a-personal-access-token-for-the-command-line](https://help.github.com/en/github/authenticating-to-github/creating-a-personal-access-token-for-the-command-line) 
